...
static constexpr std::array<const char*, 51> locations_array__ =
  ...
  " (in 'Gompertz', line 40, column 2 to column 17)",
  " (in 'Gompertz', line 41, column 2 to column 22)",
  " (in 'Gompertz', line 44, column 2 to column 20)",
  " (in 'Gompertz', line 45, column 2 to column 15)",
  " (in 'Gompertz', line 57, column 2 to column 12)",
  " (in 'Gompertz', line 46, column 2 to column 19)",
  " (in 'Gompertz', line 48, column 4 to column 28)",
  " (in 'Gompertz', line 47, column 17 to line 49, column 3)",
  " (in 'Gompertz', line 47, column 2 to line 49, column 3)",
  " (in 'Gompertz', line 58, column 2 to column 22)",
  " (in 'Gompertz', line 52, column 2 to column 33)",
  " (in 'Gompertz', line 53, column 2 to column 36)",
  " (in 'Gompertz', line 54, column 2 to column 32)",
  " (in 'Gompertz', line 29, column 2 to column 8)",
  " (in 'Gompertz', line 30, column 9 to column 10)",
  " (in 'Gompertz', line 30, column 2 to column 14)",
  " (in 'Gompertz', line 31, column 9 to column 10)",
  " (in 'Gompertz', line 31, column 2 to column 14)",
  " (in 'Gompertz', line 32, column 2 to column 8)",
  " (in 'Gompertz', line 33, column 9 to column 10)",
  " (in 'Gompertz', line 33, column 11 to column 12)",
  " (in 'Gompertz', line 33, column 2 to column 16)",
  " (in 'Gompertz', line 34, column 9 to column 10)",
  " (in 'Gompertz', line 34, column 2 to column 20)",
  " (in 'Gompertz', line 35, column 19 to column 20)",
  " (in 'Gompertz', line 35, column 2 to column 33)",
  " (in 'Gompertz', line 36, column 2 to column 24)",
  " (in 'Gompertz', line 37, column 2 to column 24)",
  " (in 'Gompertz', line 40, column 9 to column 10)",
  " (in 'Gompertz', line 44, column 9 to column 10)",
  " (in 'Gompertz', line 45, column 9 to column 10)",
  " (in 'Gompertz', line 5, column 11 to column 26)",
  " (in 'Gompertz', line 5, column 4 to column 37)",
  " (in 'Gompertz', line 6, column 4 to column 39)",
  " (in 'Gompertz', line 7, column 4 to column 20)",
  " (in 'Gompertz', line 4, column 51 to line 8, column 3)",
  " (in 'Gompertz', line 12, column 11 to column 26)",
  " (in 'Gompertz', line 12, column 4 to column 37)",
  " (in 'Gompertz', line 14, column 6 to column 61)",
  " (in 'Gompertz', line 13, column 33 to line 15, column 5)",
  " (in 'Gompertz', line 13, column 4 to line 15, column 5)",
  " (in 'Gompertz', line 16, column 4 to column 20)",
  " (in 'Gompertz', line 11, column 51 to line 17, column 3)",
  " (in 'Gompertz', line 21, column 11 to column 26)",
  " (in 'Gompertz', line 21, column 4 to column 36)",
  " (in 'Gompertz', line 22, column 4 to column 14)",
  " (in 'Gompertz', line 23, column 4 to column 61)",
  " (in 'Gompertz', line 24, column 4 to column 24)",
  " (in 'Gompertz', line 25, column 4 to column 16)",
  " (in 'Gompertz', line 20, column 72 to line 26, column 3)"};
...
log_h(const T0__& t_arg__, const T1__& shape, const T2__& rate_arg__,
...
Eigen::Matrix<stan::promote_args_t<stan::base_type_t<T0__>, T1__,
                stan::base_type_t<T2__>>,-1,1>
log_S(const T0__& t_arg__, const T1__& shape, const T2__& rate_arg__,
      std::ostream* pstream__);
...
surv_gompertz_lpdf(const T0__& t_arg__, const T1__& d_arg__, const T2__&
                   shape, const T3__& rate_arg__, std::ostream* pstream__);
template <typename T0__, typename T1__, typename T2__,
          stan::require_all_t<stan::is_col_vector<T0__>,
                              stan::is_vt_not_complex<T0__>,
                              stan::is_stan_scalar<T1__>,
...
log_h(const T0__& t_arg__, const T1__& shape, const T2__& rate_arg__,
  ...
  try {
    ...
    stan::model::assign(log_hvec,
      stan::math::add(stan::math::log(rate), stan::math::multiply(shape, t)),
  ...
  try {
    ...
    for (int i = 1; i <= stan::math::num_elements(t); ++i) {
      ...
      stan::model::assign(log_Svec,
        ...
        "assigning variable log_Svec", stan::model::index_uni(i));
    }
...
surv_gompertz_lpdf(const T0__& t_arg__, const T1__& d_arg__, const T2__&
  ...
  try {
    ...
    stan::model::assign(log_lik,
      stan::math::add(
        stan::math::elt_multiply(d, log_h(t, shape, rate, pstream__)),
        log_S(t, shape, rate, pstream__)), "assigning variable log_lik");
...
class model_Gompertz final : public model_base_crtp<model_Gompertz> {
private:
  int n;
...
public:
  ~model_Gompertz() {}
  model_Gompertz(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_Gompertz_namespace::model_Gompertz";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_Gompertz_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      }
      {
        ...
        lp_accum__.add(surv_gompertz_lpdf<propto__>(t, d, alpha, mu,
                         pstream__));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_Gompertz_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
...
using stan_model = model_Gompertz_namespace::model_Gompertz;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_Gompertz_namespace::profiles__;
}
#endif
#endif
