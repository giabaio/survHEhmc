...
static constexpr std::array<const char*, 53> locations_array__ =
  ...
  " (in 'logLogistic', line 42, column 2 to column 17)",
  " (in 'logLogistic', line 43, column 2 to column 22)",
  " (in 'logLogistic', line 46, column 2 to column 20)",
  " (in 'logLogistic', line 47, column 2 to column 15)",
  " (in 'logLogistic', line 59, column 2 to column 12)",
  " (in 'logLogistic', line 48, column 2 to column 19)",
  " (in 'logLogistic', line 50, column 4 to column 28)",
  " (in 'logLogistic', line 49, column 17 to line 51, column 3)",
  " (in 'logLogistic', line 49, column 2 to line 51, column 3)",
  " (in 'logLogistic', line 60, column 2 to column 22)",
  " (in 'logLogistic', line 54, column 2 to column 33)",
  " (in 'logLogistic', line 55, column 2 to column 36)",
  " (in 'logLogistic', line 56, column 2 to column 35)",
  " (in 'logLogistic', line 31, column 2 to column 8)",
  " (in 'logLogistic', line 32, column 9 to column 10)",
  " (in 'logLogistic', line 32, column 2 to column 14)",
  " (in 'logLogistic', line 33, column 9 to column 10)",
  " (in 'logLogistic', line 33, column 2 to column 14)",
  " (in 'logLogistic', line 34, column 2 to column 8)",
  " (in 'logLogistic', line 35, column 9 to column 10)",
  " (in 'logLogistic', line 35, column 11 to column 12)",
  " (in 'logLogistic', line 35, column 2 to column 16)",
  " (in 'logLogistic', line 36, column 9 to column 10)",
  " (in 'logLogistic', line 36, column 2 to column 20)",
  " (in 'logLogistic', line 37, column 19 to column 20)",
  " (in 'logLogistic', line 37, column 2 to column 33)",
  " (in 'logLogistic', line 38, column 2 to column 24)",
  " (in 'logLogistic', line 39, column 2 to column 24)",
  " (in 'logLogistic', line 42, column 9 to column 10)",
  " (in 'logLogistic', line 46, column 9 to column 10)",
  " (in 'logLogistic', line 47, column 9 to column 10)",
  " (in 'logLogistic', line 5, column 11 to column 26)",
  " (in 'logLogistic', line 5, column 4 to column 37)",
  " (in 'logLogistic', line 7, column 6 to column 115)",
  " (in 'logLogistic', line 6, column 33 to line 8, column 5)",
  " (in 'logLogistic', line 6, column 4 to line 8, column 5)",
  " (in 'logLogistic', line 9, column 4 to column 20)",
  " (in 'logLogistic', line 4, column 52 to line 10, column 3)",
  " (in 'logLogistic', line 14, column 11 to column 26)",
  " (in 'logLogistic', line 14, column 4 to column 37)",
  " (in 'logLogistic', line 16, column 6 to column 55)",
  " (in 'logLogistic', line 15, column 33 to line 17, column 5)",
  " (in 'logLogistic', line 15, column 4 to line 17, column 5)",
  " (in 'logLogistic', line 18, column 4 to column 20)",
  " (in 'logLogistic', line 13, column 52 to line 19, column 3)",
  " (in 'logLogistic', line 23, column 11 to column 26)",
  " (in 'logLogistic', line 23, column 4 to column 36)",
  " (in 'logLogistic', line 24, column 4 to column 14)",
  " (in 'logLogistic', line 25, column 4 to column 63)",
  " (in 'logLogistic', line 26, column 4 to column 24)",
  " (in 'logLogistic', line 27, column 4 to column 16)",
  " (in 'logLogistic', line 22, column 76 to line 28, column 3)"};
...
log_h(const T0__& t_arg__, const T1__& shape, const T2__& scale_arg__,
...
Eigen::Matrix<stan::promote_args_t<stan::base_type_t<T0__>, T1__,
                stan::base_type_t<T2__>>,-1,1>
log_S(const T0__& t_arg__, const T1__& shape, const T2__& scale_arg__,
      std::ostream* pstream__);
...
surv_loglogistic_lpdf(const T0__& t_arg__, const T1__& d_arg__, const T2__&
                      shape, const T3__& scale_arg__, std::ostream* pstream__);
template <typename T0__, typename T1__, typename T2__,
          stan::require_all_t<stan::is_col_vector<T0__>,
                              stan::is_vt_not_complex<T0__>,
                              stan::is_stan_scalar<T1__>,
...
log_h(const T0__& t_arg__, const T1__& shape, const T2__& scale_arg__,
  ...
  try {
    ...
    for (int i = 1; i <= stan::math::num_elements(t); ++i) {
      ...
      stan::model::assign(log_hvec, (((stan::math::log(shape) -
        stan::math::log(
        ...
        stan::math::log((1 +
          stan::math::pow(
            (stan::model::rvalue(t, "t", stan::model::index_uni(i)) /
            stan::model::rvalue(scale, "scale", stan::model::index_uni(i))),
            shape)))), "assigning variable log_hvec",
      ...
      stan::model::assign(log_Svec,
        -stan::math::log((1 +
           stan::math::pow(
             (stan::model::rvalue(t, "t", stan::model::index_uni(i)) /
             stan::model::rvalue(scale, "scale", stan::model::index_uni(i))),
             shape))), "assigning variable log_Svec",
        stan::model::index_uni(i));
    }
...
surv_loglogistic_lpdf(const T0__& t_arg__, const T1__& d_arg__, const T2__&
  ...
  try {
    ...
    stan::model::assign(log_lik,
      stan::math::add(
        stan::math::elt_multiply(d, log_h(t, shape, scale, pstream__)),
        log_S(t, shape, scale, pstream__)), "assigning variable log_lik");
...
class model_logLogistic final : public model_base_crtp<model_logLogistic> {
private:
  int n;
...
public:
  ~model_logLogistic() {}
  model_logLogistic(stan::io::var_context& context__, unsigned int
    ...
    static constexpr const char* function__ =
      "model_logLogistic_namespace::model_logLogistic";
    // suppress unused var warning
    (void) function__;
    local_scalar_t__ DUMMY_VAR__(std::numeric_limits<double>::quiet_NaN());
    // suppress unused var warning
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    (void) DUMMY_VAR__;
    static constexpr const char* function__ =
      "model_logLogistic_namespace::log_prob";
    // suppress unused var warning
    (void) function__;
    try {
      ...
      }
      {
        ...
        lp_accum__.add(surv_loglogistic_lpdf<propto__>(t, d, alpha, mu,
                         pstream__));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    static constexpr const char* function__ =
      "model_logLogistic_namespace::write_array";
    // suppress unused var warning
    (void) function__;
    try {
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(H) + "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"linpred\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n) + "},\"block\":\"transformed_parameters\"},{\"name\":\"mu\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(n) + "},\"block\":\"transformed_parameters\"},{\"name\":\"rate\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
...
using stan_model = model_logLogistic_namespace::model_logLogistic;
#ifndef USING_R
// Boilerplate
...
stan::math::profile_map& get_stan_profile_data() {
  return model_logLogistic_namespace::profiles__;
}
#endif
#endif
