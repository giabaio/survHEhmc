...
static constexpr std::array<const char*, 48> locations_array__ =
  ...
  " (in 'logNormal', line 43, column 2 to column 17)",
  " (in 'logNormal', line 44, column 2 to column 22)",
  " (in 'logNormal', line 52, column 2 to column 15)",
  " (in 'logNormal', line 53, column 2 to column 20)",
  " (in 'logNormal', line 47, column 2 to column 35)",
  " (in 'logNormal', line 48, column 2 to column 36)",
  " (in 'logNormal', line 49, column 2 to column 37)",
  " (in 'logNormal', line 32, column 2 to column 8)",
  " (in 'logNormal', line 33, column 9 to column 10)",
  " (in 'logNormal', line 33, column 2 to column 14)",
  " (in 'logNormal', line 34, column 9 to column 10)",
  " (in 'logNormal', line 34, column 2 to column 14)",
  " (in 'logNormal', line 35, column 2 to column 8)",
  " (in 'logNormal', line 36, column 9 to column 10)",
  " (in 'logNormal', line 36, column 11 to column 12)",
  " (in 'logNormal', line 36, column 2 to column 16)",
  " (in 'logNormal', line 37, column 9 to column 10)",
  " (in 'logNormal', line 37, column 2 to column 20)",
  " (in 'logNormal', line 38, column 19 to column 20)",
  " (in 'logNormal', line 38, column 2 to column 33)",
  " (in 'logNormal', line 39, column 2 to column 15)",
  " (in 'logNormal', line 40, column 2 to column 15)",
  " (in 'logNormal', line 43, column 9 to column 10)",
  " (in 'logNormal', line 5, column 11 to column 26)",
  " (in 'logNormal', line 5, column 4 to column 37)",
  " (in 'logNormal', line 7, column 6 to column 55)",
  " (in 'logNormal', line 6, column 33 to line 8, column 5)",
  " (in 'logNormal', line 6, column 4 to line 8, column 5)",
  " (in 'logNormal', line 9, column 4 to column 20)",
  " (in 'logNormal', line 4, column 48 to line 10, column 3)",
  " (in 'logNormal', line 14, column 11 to column 26)",
  " (in 'logNormal', line 14, column 4 to column 37)",
  " (in 'logNormal', line 15, column 11 to column 26)",
  " (in 'logNormal', line 15, column 4 to column 31)",
  " (in 'logNormal', line 16, column 4 to column 26)",
  " (in 'logNormal', line 18, column 6 to column 60)",
  " (in 'logNormal', line 17, column 33 to line 19, column 5)",
  " (in 'logNormal', line 17, column 4 to line 19, column 5)",
  " (in 'logNormal', line 20, column 4 to column 20)",
  " (in 'logNormal', line 13, column 48 to line 21, column 3)",
  " (in 'logNormal', line 24, column 11 to column 26)",
  " (in 'logNormal', line 24, column 4 to column 36)",
  " (in 'logNormal', line 25, column 4 to column 14)",
  " (in 'logNormal', line 26, column 4 to column 55)",
  " (in 'logNormal', line 27, column 4 to column 24)",
  " (in 'logNormal', line 28, column 4 to column 16)",
  " (in 'logNormal', line 23, column 70 to line 29, column 3)"};
...
surv_lognormal_lpdf(const T0__& t_arg__, const T1__& d_arg__, const T2__&
                    mean_arg__, const T3__& sd, std::ostream* pstream__);
template <typename T0__, typename T1__, typename T2__,
          stan::require_all_t<stan::is_col_vector<T0__>,
                              stan::is_vt_not_complex<T0__>,
                              stan::is_col_vector<T1__>,
...
log_S(const T0__& t_arg__, const T1__& mean_arg__, const T2__& sd,
  ...
  const auto& mean = stan::math::to_ref(mean_arg__);
      ...
      stan::model::assign(log_Svec,
        stan::math::log((1 -
          stan::math::Phi(
            ...
            sd)))), "assigning variable log_Svec", stan::model::index_uni(i));
    }
...
log_h(const T0__& t_arg__, const T1__& mean_arg__, const T2__& sd,
  ...
  try {
    ...
    stan::math::validate_non_negative_index("ls", "num_elements(t)",
      stan::math::num_elements(t));
    Eigen::Matrix<local_scalar_t__,-1,1> ls =
      Eigen::Matrix<local_scalar_t__,-1,1>::Constant(stan::math::num_elements(
                                                       t), DUMMY_VAR__);
    current_statement__ = 35;
    stan::model::assign(ls, log_S(t, mean, sd, pstream__),
    ...
    for (int i = 1; i <= stan::math::num_elements(t); ++i) {
      ...
      stan::model::assign(log_hvec,
        (stan::math::lognormal_lpdf<false>(
           stan::model::rvalue(t, "t", stan::model::index_uni(i)),
           stan::model::rvalue(mean, "mean", stan::model::index_uni(i)), sd)
        - stan::model::rvalue(ls, "ls", stan::model::index_uni(i))),
        "assigning variable log_hvec", stan::model::index_uni(i));
    }
...
surv_lognormal_lpdf(const T0__& t_arg__, const T1__& d_arg__, const T2__&
  ...
  try {
    ...
    stan::model::assign(log_lik,
      stan::math::add(
        stan::math::elt_multiply(d, log_h(t, mean, sd, pstream__)),
...
public:
  ...
  log_prob_impl(VecR& params_r__, VecI& params_i__, std::ostream*
    ...
    try {
                ...
                jacobian__>(0, lp__);
      {
        ...
        lp_accum__.add(stan::math::uniform_lpdf<propto__>(alpha, a_alpha,
                         b_alpha));
        current_statement__ = 6;
        lp_accum__.add(stan::math::normal_lpdf<propto__>(beta, mu_beta,
                         sigma_beta));
        current_statement__ = 7;
        lp_accum__.add(surv_lognormal_lpdf<propto__>(t, d,
                         stan::math::multiply(X, beta), alpha, pstream__));
      }
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  write_array_impl(RNG& base_rng__, VecR& params_r__, VecI& params_i__,
    ...
    try {
      ...
      double meanlog = std::numeric_limits<double>::quiet_NaN();
      current_statement__ = 4;
      meanlog = stan::model::rvalue(beta, "beta", stan::model::index_uni(1));
      out__.write(meanlog);
    } catch (const std::exception& e) {
      stan::lang::rethrow_located(e, locations_array__[current_statement__]);
    }
  ...
  get_param_names(std::vector<std::string>& names__, const bool
    ...
    if (emit_generated_quantities__) {
      std::vector<std::string> temp{"meanlog"};
  ...
  inline std::string get_constrained_sizedtypes() const {
    return std::string("[{\"name\":\"beta\",\"type\":{\"name\":\"vector\",\"length\":" + std::to_string(H) + "},\"block\":\"parameters\"},{\"name\":\"alpha\",\"type\":{\"name\":\"real\"},\"block\":\"parameters\"},{\"name\":\"meanlog\",\"type\":{\"name\":\"real\"},\"block\":\"generated_quantities\"}]");
  }
